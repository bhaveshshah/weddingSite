jQuery(function($) {
    var styleSwitcher = {
        ...
        initialize: function() {
            ...
            // Style Switcher CSS
            $("body").append($('<link rel="stylesheet">').attr("href", "assets/css/font-awesome.css"));
            $("body").append($('<link rel="stylesheet">').attr("href", "assets/css/theme_panel.css"));
            ...
            $("body").append($('<link rel="stylesheet/less">').attr("href", "assets/css/skin.less"));

            $.getScript("assets/js/less.js", function(data, textStatus, jqxhr) {
                $.getScript("assets/js/jquery.easing.js", function(data, textStatus, jqxhr) {
